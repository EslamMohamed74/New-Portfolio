  ...
  return (
    ...
    >
      ...
      <p className="text-gray-700 -mt-6 dark:text-white/80">
        ...
        <a className="underline" href="mailto:eslam.mo.hussein@gmail.com">
          eslam.mo.hussein@gmail.com
        </a>{" "}
      ...
      >
        ...
        />
        <textarea
          className="w-full h-52 my-3 rounded-lg borderBlack p-4 dark:bg-white dark:bg-opacity-80 dark:focus:bg-opacity-100 transition-all dark:outline-none"
          name="message"
